...
```javascript
FLOAT32_SQRT_PI = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-float32-sqrt-pi@v0.1.0-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/constants-float32-sqrt-pi/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/constants-float32-sqrt-pi/actions/workflows/test.yml?query=branch:v0.1.0
